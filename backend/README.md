...
## Project Structure
    ...
    ├── werstdyrtuyiu_dev_54256  # Django project configurations
...
1. Clone this repo and `cd werstdyrtuyiu_dev_54256`
...
2. Clone this repo and `cd werstdyrtuyiu_dev_54256`
